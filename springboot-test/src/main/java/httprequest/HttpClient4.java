...
public class HttpClient4 {
	...
	public static void main(String[] args) {
		...
		// https://blog.csdn.net/lan_qinger/article/details/79730435
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("loginname", "system");
		jsonObject.put("password", "system");
		String body = jsonObject.toJSONString();
		String result = doPost("http://10.10.12.198:8181/login", body);
