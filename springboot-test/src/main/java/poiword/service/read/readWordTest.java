...
public class readWordTest {
	public static void main(String[] args) {
		...
		test.testWord("g:\\test2007.docx");
		test.testWord("g:\\test2003.doc");
	}
				...
				while (it.hasNext()) {
					...
					for (int i = 0; i < rows.size(); i++) {
						...
						for (int j = 0; j < cells.size(); j++) {
							...
							if("1.负责人：".equals(cell.getText())){
								System.err.println(cells.get(j+1).getText());
							}
						}
						System.out.println();
					}
